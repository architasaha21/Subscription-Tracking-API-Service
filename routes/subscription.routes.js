...
subscriptionRouter.post('/', (req, res) => res.json({ title: 'CREATE a new subscription' }));
...
subscriptionRouter.get('/users/:id', (req, res) => res.json({ title: 'GET all user subscriptions' }));
